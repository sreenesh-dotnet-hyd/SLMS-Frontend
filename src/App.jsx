      ...
      <Router>
        <Routes>
          ...
          <Route path="/app" element={<Layout />}>
            ...
            <Route path="software-catalog/software-management" element={<SoftwareCRUD />} />
            <Route path="software-catalog/software-details" element={<SoftwareDetails />} />
            ...
            {/* Licenses */}
            <Route path="licenses" element={<LicensesListPage role={currentRole} />} />
            <Route path="licenses/new" element={<LicenseFormPage />} />
            <Route path="licenses/:id/edit" element={<LicenseFormPage />} />
            <Route path="licenses/:id" element={<LicenseDetailsPage role={currentRole} />} />

            {/* Entitlements */}
            <Route path="entitlements" element={<EntitlementListPage />} />
            <Route path="entitlements/assign" element={<AssignEntitlementPage />} />

            {/* Installations */}
            <Route path="installed" element={<InstalledSoftwareListPage />} />
            <Route path="devices/:deviceId/installed" element={<DeviceInstallationsPage />} />
            <Route path="installed/:id/history" element={<InstallationHistoryPage />} />

            {/* Dashboard */}
            <Route path="dashboard/renewals" element={<RenewalDashboard />} />
            <Route path="dashboards/" element={<ItAdminDashboard />} />
             <Route path="dashboards/finance-dashboard" element={<FinanceDashboard />} />
              <Route path="dashboards/user-dashboard" element={<UserDashboard />} />
               <Route path="dashboards/auditor-dashboard" element={<AuditorDashboard/>} />
          </Route>
        </Routes>
      </Router>
    </div>
