        ...
        <div className="second-content">
            <div className="second-sub-1">
                ...
                <div className="second-sub-card">
                    ...
                    <span className="second-card-content">
                        Track and manage all organizational devices with full visibility into their configuration and installed software.
                        This module helps you maintain accurate device records and ensure compliance across your environment.
                    </span>
                </div>
                <div className="second-sub-card">
                    <div className="second-bg-logo">
                    ...
                    <span className="second-card-content">
                        Manage every user in your organization with complete visibility into their licenses and assigned devices.
            ...
            <div className="second-sub-2">
                <div className="second-sub-card">
                    ...
                    <span className="second-card-content">
                        Your central hub for tracking software licenses, vendor contracts, entitlements,
                        and real-world usage. The License Management module ensures full compliance, avoids overspending,
                        and gives you total control over your licensing landscape.
                    </span>
                </div>
                <div className="second-sub-card">
                    <div className="second-bg-logo">
                ...
                <div className="second-sub-card">
                    ...
                    <span className="second-card-content">
                        Manage how license seats are distributed across users and devices with complete clarity. The Entitlement & Seat Allocation
                        module ensures you never run out of seats and stay compliant with vendor limits.
                    </span>
                </div>
            </div>
        </div>
